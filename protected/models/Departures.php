 ...
 *
 * The followings are the available columns in table '{{departures}}':
 * @property integer $id
 * @property string $startDateTime
 * @property string $endDateTime
 */
class Departures extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id, startDateTime, endDateTime', 'required'),
	 ...
	 * @return Departures the static model class
	 */
